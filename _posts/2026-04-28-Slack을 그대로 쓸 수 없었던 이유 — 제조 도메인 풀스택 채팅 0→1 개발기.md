...
# 커버 이미지: assets/2026-04-28-mes-chat-cover.png 파일을 추가한 뒤 아래 2줄의 주석을 해제하세요.
# image:
...
<!-- TODO: 이미지 미업로드. assets/ 에 파일 추가 후 주석 해제
> ![mes-chat 첫 화면 — BOM 멘션과 CAD 파일 첨부가 함께 보이는 채팅 UI](/assets/01-hero-mention-with-cad.png)
-->
...
<!-- TODO: 이미지 미업로드. assets/ 에 파일 추가 후 주석 해제
> ![아키텍처 다이어그램](/assets/02-architecture.png)
-->
...
<!-- TODO: 이미지 미업로드. assets/ 에 파일 추가 후 주석 해제
> ![멘션 자동완성 드롭다운 — 사용자/BOM/ITEM 혼합 후보](/assets/03-mention-autocomplete.png)
-->
...
<!-- TODO: 이미지 미업로드. assets/ 에 파일 추가 후 주석 해제
> ![파일 업로드 UI — CAD + 이미지 동시 batch 업로드](/assets/04-file-upload-batch.png)
-->
...
<!-- TODO: 이미지 미업로드. assets/ 에 파일 추가 후 주석 해제
> ![사업장 전환 UI — 같은 사용자가 사업장 A에서 B로 이동](/assets/05-tenant-switch.png)
-->
...
<!-- TODO: 이미지 미업로드. assets/ 에 파일 추가 후 주석 해제
> ![링크 미리보기 카드 UI](/assets/06-link-preview-card.png)
-->
...
<!-- TODO: 이미지 미업로드. assets/ 에 파일 추가 후 주석 해제
> ![운영 대시보드 Grafana 캡처](/assets/07-grafana-dashboard.png)
-->
