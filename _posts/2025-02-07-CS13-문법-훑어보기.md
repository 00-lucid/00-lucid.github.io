...
### 들어가기 앞서
CS12 버전을 사용하다가 13 버전이 최근 업데이트가 된 것을 알았습니다.

그 중에 몇개만 예제 코드를 중심으로 기록합니다.

### params 컬렉션

기존 CS에서 params는 배열에만 사용할 수 있었습니다. 하지만 CS13 에서는 다음과 같은 타입들로 확장되었습니다
...
field 키워드의 경우 CS13 에서도 미리보기 기능으로 사용하실 수 있습니다. syntax sugar 키워드 느낌이네요.
